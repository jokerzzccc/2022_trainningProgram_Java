...
public class Topic85 {
    public static void main(String[] args) {
        ...
        ArrayList<String> stringArrayList = (ArrayList<String>) Stream.of(strings).collect(Collectors.toList());


        StringBuilder builder = new StringBuilder();// 屏幕上存在的字母

        String choose = "";// 选择的字母
        String tab = "";// 粘贴板

        for (String op : stringArrayList) {
            switch (op) {
                case "1": // A
